...
@if ($message = Session::get('success'))
    <div class="bg-red-100 border border-red-400 text-teal-700 px-4 py-3 rounded relative alert-hide" role="alert">
...
@if ($message = Session::get('danger'))
    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative alert-hide" role="alert">
...
@if ($message = Session::get('warning'))
    <div class="bg-red-100 border border-red-400 text-orange-700 px-4 py-3 rounded relative alert-hide" role="alert">
...
@if ($message = Session::get('info'))
    <div class="bg-red-100 border border-red-400 text-blue-700 px-4 py-3 rounded relative alert-hide" role="alert">

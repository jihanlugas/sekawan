...
@section('content')
    <div class="flex items-center">
        <div class="md:w-1/2 md:mx-auto">
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md p-3">
                ...
                <form method="POST" action="{{ route('completedata') }}">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="name" type="text" class="form-input w-full cursor-not-allowed bg-gray-200" name="name" value="{{ $mUser->name }}" readonly>
                    </div>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="text" class="form-input w-full cursor-not-allowed bg-gray-200" name="email" value="{{ $mUser->email }}" readonly>
                    </div>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="birth_dt" type="text" class="form-input w-full flatpickr @error('birth_dt') border-red-500 @enderror" name="birth_dt" value="{{ old('birth_dt') }}" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <div class="relative w-full">
                            <select class="block form-input appearance-none w-full pr-8" id="grid-state" name="bank_id" value="{{ old('bank_id') }}" required autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="bank_account_number" type="text" class="form-input w-full @error('bank_account_number') border-red-500 @enderror" name="bank_account_number" value="{{ old('bank_account_number') }}" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="bank_account_name" type="text" class="form-input w-full @error('bank_account_name') border-red-500 @enderror" name="bank_account_name" value="{{ old('bank_account_name') }}" autofocus>

            ...
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md p-3">
                    ...
                    @foreach($mUsertrees as $i => $mUsertree)
                        <form method="POST" action="{{ route('upload') }}"
                            ...
                            <div class="max-w-full rounded overflow-hidden shadow-lg mb-3 usertreeCard">
                                ...
                                <div class="px-6 py-4">
                                    <div
                                        class="font-bold text-xl mb-2 usertreeStatus"><?= $mUsertree->status_photo ?></div>
                ...
                @if($complete)
                        <div class="col text-right">
                            ...
                            <a href="{{ route('completedata') }}" class="inline-block align-middle text-center select-none border font-bold whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-gray-100 bg-blue-500 hover:bg-blue-700">Complete Data</a>
                        </div>
                @endif
            </div>
        </div>
